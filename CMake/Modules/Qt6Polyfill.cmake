if(NOT QT_DEFAULT_MAJOR_VERSION EQUAL 6)
    message(ERROR "Polyfill is for use under Qt6 only")
endif()
...
function(qt_add_translations)
    ...
    qt6_add_translation(qmFiles ${arg_TS_FILES})
    ...
    foreach(target ${targets})
        ...
        qt6_add_resources(translation_SRCS ${CMAKE_BINARY_DIR}/${target}_translations.qrc)
